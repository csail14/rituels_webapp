        ...
        const apiCall = async () => {
            try {
              ...
              axios.post(config.api_url+'/api/v1/paiment/checkout',data).then(
                  (res)=>{
                      window.location.href ='https://paiment-4brn.herokuapp.com/'+res.data.sessionId
                  }
              )
            } catch (error) {
              console.log(error);
    ...
    render() {
        return(
            ...
            <div className='Main'>
                ...
                >Voir les infos de mon pack.</button>
                </>}
                ...
                <p className='text'>Vous n'avez pas encore choisi votre pack</p>
                    ...
                    <div className='pack'>
                        ...
                        <button
                            className='buy-button'
                            onClick={()=>this.paiement('price_1IZDjWJwXSakrFau37sJondx','kids')}
                    ...
                    <div className='pack'>
                        ...
                        <button
                            className='buy-button'
                            onClick={()=>this.paiement('price_1IZDkSJwXSakrFauYSsgNXAi','family')}
                        >Choisir ce pack</button>
