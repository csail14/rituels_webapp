...
export const addVideo =  async (data)=> {
    return axios.post(config.api_url+"/api/v1/video/add", data, {headers: {'x-access-token': token}} )
            .then((response)=>{
                return response.data
            })
...
export const addCycle =  async (data)=> {
    return axios.post(config.api_url+"/api/v1/cycle/add", data, {headers: {'x-access-token': token}} )
            .then((response)=>{
                return response.data
            })
            .catch((err)=>{return err})
